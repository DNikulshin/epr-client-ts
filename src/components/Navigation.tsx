            ...
            >
                <div className='d-flex mb-3 justify-content-center align-items-center w-100'>
                    <div className='d-flex align-items-center gap-4 justify-content-center mx-auto'>
                        {location.pathname === '/' && <button className="btn btn-primary btn-shadow"
                                                              onClick={() => getItems({
                        ...
                        <NavLink  to="/"
                                  className="d-flex btn bg-primary-subtle btn-outline-success btn-shadow"
                        >
                        ...
                        <NavLink to="/user" className="btn btn-shadow bg-success">
