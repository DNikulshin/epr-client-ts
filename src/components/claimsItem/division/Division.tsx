...
export const Division = (props: Iitem) => {
  ...
  if(divisionId)  await divisionDelete(id, divisionId, userId )
  }, [divisionDelete])
  ...
  useEffect(() => {
    ...
    return (
      <div className="d-flex flex-wrap w-100">
        {division &&
          division.map( item => <small className="me-1" key={item?.id}>
            {isEdit && <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-x text-danger me-1 box-shadow m-2"
                   viewBox="0 0 16 16"
